...
SEARCH_MAX_VUS=0
TAG_SEARCH_RATE=0
TAG_SEARCH_PRE_ALLOCATED_VUS=0
TAG_SEARCH_MAX_VUS=0
SORT_SEARCH_RATE=0
SORT_SEARCH_PRE_ALLOCATED_VUS=0
SORT_SEARCH_MAX_VUS=0
WRITE_START_RATE=0
...
enable_profile_component() {
  ...
  case "$component" in
    browse_search)
      ...
      TAG_SEARCH_RATE="${TAG_SEARCH_RATE_OVERRIDE:-${SEARCH_RATE_OVERRIDE:-40}}"
      TAG_SEARCH_PRE_ALLOCATED_VUS="${TAG_SEARCH_PRE_ALLOCATED_VUS_OVERRIDE:-${SEARCH_PRE_ALLOCATED_VUS_OVERRIDE:-20}}"
      TAG_SEARCH_MAX_VUS="${TAG_SEARCH_MAX_VUS_OVERRIDE:-${SEARCH_MAX_VUS_OVERRIDE:-80}}"
      SORT_SEARCH_RATE="${SORT_SEARCH_RATE_OVERRIDE:-${SEARCH_RATE_OVERRIDE:-40}}"
      SORT_SEARCH_PRE_ALLOCATED_VUS="${SORT_SEARCH_PRE_ALLOCATED_VUS_OVERRIDE:-${SEARCH_PRE_ALLOCATED_VUS_OVERRIDE:-20}}"
      SORT_SEARCH_MAX_VUS="${SORT_SEARCH_MAX_VUS_OVERRIDE:-${SEARCH_MAX_VUS_OVERRIDE:-80}}"
      ;;
    browse_board_feed)
      BROWSE_RATE="${BROWSE_RATE_OVERRIDE:-80}"
      BROWSE_PRE_ALLOCATED_VUS="${BROWSE_PRE_ALLOCATED_VUS_OVERRIDE:-40}"
...
export TAG_SEARCH_RATE TAG_SEARCH_PRE_ALLOCATED_VUS TAG_SEARCH_MAX_VUS
export SORT_SEARCH_RATE SORT_SEARCH_PRE_ALLOCATED_VUS SORT_SEARCH_MAX_VUS
...
# 최근에는 `tag_search` 와 `sort_catalog` 를 search path에서 별도 component로 분리해
# "keyword search는 안정적이지만 tag path만 깨지는가" 같은 질문도 같은 러너로 확인한다.
